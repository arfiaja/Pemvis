...
plt.plot(x,y3, '-r', label='Telinga Kanan')
plt.plot(x,y4, '-r')

plt.plot(x,y5, '-m', label='Telinga Kiri')
plt.plot(x,y6, '-m')

plt.fill_between(x, y3, y4, color='red', alpha=1)
plt.fill_between(x, y5, y6, color='red', alpha=1)
